  ...
  <div>
    <div class="container">
          ...
          <div class="col-md-11">
            ...
            <div class="mt-2">
              <p class="mb-0 small">
                ...
                <strong
                  >Consulte abaixo seu relatório completo de participação e
                  auditoria dos eventos.</strong
                >
              </p>
            </div>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div v-if="memberReport" class="mb-4">
            <div class="row mb-4">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="row">
                      <div class="col-12 mb-3">
                        ...
                        <span class="badge bg-success ms-2"
                          >{{
                            memberReport.ideal.average_hours_per_week
                          }}h</span
                        >
                      </div>
                      <div class="col-12 mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <div v-else class="table-responsive">
                      <table class="table table-hover">
                        ...
                        <tbody>
                          <tr
                            v-for="event in memberReport.events"
                            :key="event.id"
                          >
                            <td>
          ...
          <div v-else-if="hasError" class="text-center text-muted py-5">
            <i class="fas fa-exclamation-triangle fa-3x mb-3 text-warning"></i>
            <h5>Relatório não encontrado</h5>
            <p>
              Não foi possível encontrar um relatório para o RA informado.
              Verifique se o RA está correto.
            </p>
          </div>
        </div>
      </div>
...
import { getPublicHoursReport } from "@/api/public_reports";
...
export default {
  ...
  mounted() {
    ...
    if (ra) {
      this.loadMemberReport(ra);
    } else {
      this.hasError = true;
    }
  },
  methods: {
    async loadMemberReport(ra) {
      this.isLoading = true;
      this.hasError = false;
      this.memberReport = null;

      await handleRequest({
        request: () => getPublicHoursReport({ ra }),
